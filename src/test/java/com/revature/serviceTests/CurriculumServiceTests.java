...
class CurriculumServiceTests {
	...
	void findById_returnsCurriculum() {
		...
		assertEquals("findByCurriculumId did not return the curriculum", cs.getById(this.curriculum.getCurriculumId()),
				this.curriculum);
	}
	...
	void findByName_returnsCurriculum() {
		...
		assertEquals("findByCurriculumId did not return the curriculum",
				cs.getByCurriculumName(this.curriculum.getCurriculumName()), this.curriculum);
	}
